...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    calories: 650,
    volume: '12 inch',
    ingredients: ['pizza dough', 'tomato sauce', 'mozzarella', 'pepperoni', 'tomato sauce', 'mozzarella', 'pepperoni', 'tomato sauce', 'mozzarella', 'pepperoni', 'tomato sauce', 'mozzarella', 'oregano'],
    available: true,
    quantity: 10,
    rating: 4.8,
    isFavorite: false
