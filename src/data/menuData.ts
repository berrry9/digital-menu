...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    calories: 680,
    volume: '12 inch',
    ingredients: ['Wheat flour', 'BBQ sauce', 'mozzarella', 'grilled chicken', 'red onions', 'BBQ sauce', 'mozzarella', 'grilled chicken', 'red onions', 'BBQ sauce', 'mozzarella', 'grilled chicken', 'cilantro'],
    available: true,
    quantity: 8,
    rating: 4.6,
    isFavorite: false
  },
  {
    ...
    calories: 600,
    volume: '12 inch',
    ingredients: ['pizza dough', 'white sauce', 'ricotta', 'mozzarella', 'garlic', 'herbs'],
    available: true,
    quantity: 7,
    rating: 4.5,
    isFavorite: false
  },
  {
    ...
    calories: 640,
    volume: '12 inch',
    ingredients: ['pizza dough', 'white sauce', 'mozzarella', 'shrimp', 'calamari', 'herbs'],
    available: true,
    quantity: 4,
    rating: 4.7,
    isFavorite: true
