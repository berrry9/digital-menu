...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    calories: 180,
    volume: '300g',
    ingredients: ['Beef', 'Tomato', 'Onion', 'G.Papper', 'Injera', 'Butter', 'Oil', 'Salt'],
    available: true,
    quantity: 15,
    rating: 4.3,
    isFavorite: false
  ...
  },
  {
    ...
    calories: 650,
    volume: '12 inch',
    ingredients: ['Wheat flour', 'Tomato', 'Cheese', 'Beef', 'Chicken', 'Tuna', 'G.papper', 'Olive', 'Onion', 'Salt', 'Oil', 'Mushroom', 'Egg'],
    available: true,
    quantity: 10,
    rating: 4.8,
    isFavorite: false
  },
  {
    ...
    calories: 620,
    volume: '12 inch',
    ingredients: ['Wheat flour', 'Chicken', 'Cheese', 'Tomato', 'G.papper', 'Onion', 'Organo', 'Oil', 'Salt'],
    available: true,
    quantity: 7,
    rating: 4.5,
    isFavorite: false
  ...
  },
  {
    ...
    calories: 780,
    volume: '12 inch',
    ingredients: ['Wheat flour', 'Cheese', 'Tomato', 'Beef', 'Olive', 'G.papper', 'Onion', 'Organo', 'Salt', 'Oil'],
    available: true,
    quantity: 6,
    rating: 4.8,
    isFavorite: false
  },
  {
    ...
    calories: 680,
    volume: '12 inch',
    ingredients: ['Wheat flour', 'Cheese', 'Tuna', 'Tomato', 'Zikuni', 'Carrot', 'Olive', 'G.papper', 'Onion', 'Organo', 'Salt', 'Oil'],
    available: true,
    quantity: 8,
    rating: 4.6,
    isFavorite: false
  ...
  },
  {
    ...
    calories: 640,
    volume: '12 inch',
    ingredients: ['Wheat flour', 'white sauce', 'mozzarella', 'calamari', 'white sauce', 'shrimp', 'calamari', 'white sauce', 'mozzarella', 'shrimp', 'calamari', 'herbs'],
    available: true,
    quantity: 4,
    rating: 4.7,
    isFavorite: true
  ...
  // GRILL - Burger (3 items)
  {
    ...
    calories: 680,
    volume: '300g',
    ingredients: ['beef patty', 'burger bun', 'lettuce', 'tomato', 'cheese', 'onions'],
    available: true,
    quantity: 12,
    rating: 4.6,
    isFavorite: false
