...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    calories: 620,
    volume: '350g',
    ingredients: ['Tomato', 'Onion', 'Zikuni', 'Cabbage', 'Garlic', 'Carrot', 'Zikuni', 'Cabbage', 'Garlic', 'nutmeg'],
    available: true,
    quantity: 7,
    rating: 4.5,
    isFavorite: true
  },
  {
    ...
    calories: 480,
    volume: '370g',
    ingredients: ['spaghetti', 'fresh clams', 'white wine', 'garlic', 'parsley', 'olive oil'],
    available: true,
    quantity: 6,
    rating: 4.8,
    isFavorite: false
