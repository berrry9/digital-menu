...
export const menuItems: MenuItem[] = [
  ...
  // GRILL - Burger (3 items)
  {
    ...
    calories: 680,
    volume: '300g',
    ingredients: ['beef patty', 'burger bun', 'cheese', 'burger bun', 'lettuce', 'tomato', 'cheese', 'burger bun', 'lettuce', 'tomato', 'cheese', 'onions'],
    available: true,
    quantity: 12,
    rating: 4.6,
    isFavorite: false
  },
  {
    ...
    calories: 580,
    volume: '280g',
    ingredients: ['chicken breast', 'burger bun', 'avocado', 'lettuce', 'mayo', 'tomato'],
    available: true,
    quantity: 10,
    rating: 4.5,
    isFavorite: false
