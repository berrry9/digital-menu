...
export const menuItems: MenuItem[] = [
  ...
  // SPECIALS - Salad (4 items)
  {
    ...
    calories: 320,
    volume: '250g',
    ingredients: ['Lettuce', 'Tomato', 'G.Pepper', 'Carrot', 'Cucumber', 'Oil', 'Venger', 'Salt', 'W.Pepper', 'Onion'],
    available: true,
    quantity: 16,
    rating: 4.5,
    isFavorite: false
  },
  {
    ...
    calories: 280,
    volume: '280g',
    ingredients: ['Onion', 'Chicken', 'Tomato', 'G.Pepper', 'Lettuce', 'Mayonnise', 'Oil', 'Salt', 'W.Pepper'],
    available: true,
    quantity: 14,
    rating: 4.6,
    isFavorite: true
  },
  {
    ...
    calories: 520,
    volume: '320g',
    ingredients: ['Tuna', 'Lettuce', 'Onion', 'Tomato', 'G.Pepper', 'Cucumber', 'Veinger', 'Salt', 'Oil', 'W.Pepper'],
    available: true,
    quantity: 10,
    rating: 4.7,
    isFavorite: false
  ...
  // SPECIALS - Breakfast (9 items)
  {
    ...
    calories: 720,
    volume: '450g',
    ingredients: ['Eggs', 'Tomato', 'Onion', 'Pepper', 'Served with Toast bread'],
    available: true,
    quantity: 8,
    rating: 4.6,
    isFavorite: false
  },
  {
    ...
    calories: 520,
    volume: '300g',
    ingredients: ['Cheese', 'Eggs', 'Tomato', 'Onion', 'Pepper', 'Served with Toast bread'],
    available: true,
    quantity: 15,
    rating: 4.5,
    isFavorite: true
  },
  {
    ...
    calories: 580,
    volume: '250g',
    ingredients: ['Egg', 'Tomato', 'Onion', 'Pepper', 'Served with Toast bread'],
    available: true,
    quantity: 10,
    rating: 4.7,
    isFavorite: false
  },
  {
    ...
    calories: 480,
    volume: '280g',
    ingredients: ['Enjera', 'Tomato', 'Onion', 'Pepper', 'Served with Enjera/ Bread'],
    available: true,
    quantity: 12,
    rating: 4.4,
    isFavorite: false
  },
  {
    ...
    calories: 420,
    volume: '220g',
    ingredients: ['Bread', 'Egg', 'Syrap', 'Jam'],
    available: true,
    quantity: 14,
    rating: 4.5,
    isFavorite: false
  },
  {
    ...
    calories: 350,
    volume: '200g',
    ingredients: ['Flour', 'Milk', 'Egg', 'Syrap'],
    available: true,
    quantity: 18,
    rating: 4.3,
    isFavorite: true
  ...
  },
  {
    ...
    calories: 380,
    volume: '250g',
    ingredients: ['Beef', 'Egg', 'Onion', 'G.Pepper', 'Injera', 'Butter', 'Oil', 'Salt'],
    available: true,
    quantity: 16,
    rating: 4.4,
    isFavorite: false
